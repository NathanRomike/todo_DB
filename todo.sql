...
--
-- Name: task_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--
...
ALTER TABLE task_id_seq OWNER TO "Guest";

--
-- Name: task_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--
...
--
-- Name: task_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--
...
--
-- Name: task_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest; Tablespace: 
--
